...
export default class FacilityButtonGym extends Component {
    ...
    constructor(props){
        ...
        if (this.state.sport === 'Basketball'){
            ...
            this.populateSubGymArr(
                <TouchableOpacity style={styles.sub_sub_gym} onPress={() => this.toggleRatingViewVisibility()}>
                    <ImageBackground style={styles.image} source={require('./Icons/gym.png')}>
	    ...
	    return(
            <View>
    	    	<View style={styles.container}>
    		       	<TouchableOpacity style={styles.sub_gym} onPress={() => this.toggleSubGymVisibility()}>
    		            <Image style={styles.image} source={require('./Icons/gym.png')}/>
    		        </TouchableOpacity>
                    {this._renderSubGym()}
    		    </View>
            </View>
